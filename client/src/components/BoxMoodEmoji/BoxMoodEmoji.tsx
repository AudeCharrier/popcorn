...
const moods: Mood[] = [
  { id:1, image: rire, label: "Comédie", color: "#FFD700", path: "/movies/comedie" },
  { id:2, image: romance, label: "Romance", color: "#FF4FC3", path: "/movies/romance" },
  { id:3, image: guerre, label: "Guerre", color: "#FF3B3B", path: "/movies/guerre" },
  { id:4, image: scifi, label: "Sci-Fi", color: "#7B61FF", path: "/movies/scifi" },
  { id:5, image: action, label: "Action", color: "#00BFFF", path: "/movies/action" },
  { id:6, image: drame, label: "Drame", color: "#2F4F4F", path: "/movies/drame" },
  { id:7, image: animation, label: "Animation", color: "#39FF14", path: "/movies/animation" },
  { id:8, image: fun, label: "Fun", color: "#FFA500", path: "/movies/aventure" },
];
